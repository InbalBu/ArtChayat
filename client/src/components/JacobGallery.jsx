...
function JacobGallery({ language }) {
  ...
  return (
    <div className={`${styles['gallery-container']} ${language === 'he' ? styles['gallery-rtl'] : styles['gallery-ltr']}`}>
      <Helmet>
      <title>{language === 'he' ? 'ArtChayat - יעקב חייט | גלריה | ארט חייט' : 'Jacob Chayat | Gallery | ArtChayat - ארט חייט'}</title>
        ...
        {/* Open Graph tags */}
        <meta property="og:title" content={language === 'he' ? 'ArtChayat - יעקב חייט | גלריה | ארט חייט' : 'Jacob Chayat | Gallery | ArtChayat - ארט חייט'} />
