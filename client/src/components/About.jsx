...
function About({ language }) {
    return (
        <div className={`${styles['about-container']} ${language === 'he' ? styles['about-rtl'] : styles['about-ltr']}`}>
            <Helmet>
                <title>{language === 'he' ? 'ארט חייט - מציירים סיפור אהבה' : 'Art Chayat - Painting a Love Story'}</title>
                ...
                {/* Open Graph tags */}
                <meta property="og:title" content={language === 'he' ? 'ארט חייט - מציירים סיפור אהבה' : 'Art Chayat - Painting a Love Story'} />
            ...
            <div className={styles['about-content']}>
                ...
                <div className={styles['about-image-container']}>
                    <img src={shoshiAndJacob} alt="Art Chayat" className={styles['about-image']} />
