...
const PersonalGallery = ({ language }) => {
  ...
  const images = [
    { src: painting17, dataId: 'painting17', description: language === 'he' ? 'הצייר יחזקאל שטרייכמן עם יעקב חייט | אוסף פרטי' : 'The painter Yehezkel Streichman with Jacob Chayat private collection' },
    { src: painting27, dataId: 'painting27', description: language === 'he' ? 'חגיגה בכרם - יעקב חייט | תערוכה בבנק הפועלים 2023' : 'A celebration in the vineyard - Jacob Chayat | Exhibition at Bank Hapoalim 2023' },
    ...
    { src: painting14, dataId: 'painting14', description: language === 'he' ? 'ביתם של שושי ויעקב חייט | אוסף פרטי' : 'The home of Shoshi and Jacob Chayat Private collection' },
    ...
    { src: painting4, dataId: 'painting4', description: language === 'he' ? 'ביתם של שושי ויעקב חייט | אוסף פרטי' : 'The home of Shoshi and Jacob Chayat Private collection' },
