    ...
    <HelmetProvider>
      <div className={`${styles['exhibitions-container']} ${isHebrew ? styles['exhibitions-rtl'] : styles['exhibitions-ltr']}`}>
        <Helmet>
          ...
          <link rel="alternate" href="https://artchayat.netlify.app/he/shoshi/exhibitions" hreflang="he" />
          <link rel="alternate" href="https://artchayat.netlify.app/en/shoshi/exhibitions" hreflang="en" />
        </Helmet>
          ...
          <ul>
            {isHebrew ? (
              <>
                ...
                <li>1997 - הצבת פסל סביבתי בפארק הפסלים בעינות.</li>
